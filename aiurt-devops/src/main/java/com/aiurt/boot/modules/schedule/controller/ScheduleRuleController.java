...
import com.swsc.copsms.modules.schedule.service.IScheduleRuleService;
...
public class ScheduleRuleController {
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule-分页列表查询")
	@ApiOperation(value="schedule_rule-分页列表查询", notes="schedule_rule-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule-添加")
	@ApiOperation(value="schedule_rule-添加", notes="schedule_rule-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule-编辑")
	@ApiOperation(value="schedule_rule-编辑", notes="schedule_rule-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule-通过id删除")
	@ApiOperation(value="schedule_rule-通过id删除", notes="schedule_rule-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule-批量删除")
	@ApiOperation(value="schedule_rule-批量删除", notes="schedule_rule-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule-通过id查询")
	@ApiOperation(value="schedule_rule-通过id查询", notes="schedule_rule-通过id查询")
