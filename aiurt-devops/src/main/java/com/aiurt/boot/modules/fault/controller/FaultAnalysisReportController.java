...
public class FaultAnalysisReportController {
   ...
   public Result<IPage<FaultAnalysisReportResult>> queryPageList(FaultAnalysisReportResult faultAnalysisReport,
       ...
       QueryWrapper<FaultAnalysisReportResult> queryWrapper = QueryGenerator.initQueryWrapper(faultAnalysisReport, req.getParameterMap());
       Page<FaultAnalysisReportResult> page = new Page<FaultAnalysisReportResult>(pageNo, pageSize);
       IPage<FaultAnalysisReportResult> pageList = faultAnalysisReportService.pageList(page, queryWrapper,param);
   ...
   public Result<FaultAnalysisReportDTO> add(@RequestBody FaultAnalysisReportDTO dto, HttpServletRequest req) {
   ...
   public Result<?> delete(@RequestParam(name="id",required=true) Integer id) {
       try {
           faultAnalysisReportService.deleteById(id);
       } catch (Exception e) {
