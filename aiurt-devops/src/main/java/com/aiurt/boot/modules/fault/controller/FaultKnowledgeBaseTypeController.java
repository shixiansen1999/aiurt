...
public class FaultKnowledgeBaseTypeController {
   ...
   public Result<IPage<FaultKnowledgeBaseType>> queryPageList(FaultKnowledgeBaseType faultKnowledgeBaseType,
       ...
       Result<IPage<FaultKnowledgeBaseType>> result = new Result<IPage<FaultKnowledgeBaseType>>();
   ...
   public Result<FaultKnowledgeBaseType> add(@RequestBody FaultKnowledgeBaseType faultKnowledgeBaseType, HttpServletRequest req) {
   ...
   public Result<?> delete(@RequestParam(name="id",required=true) Integer id) {
       try {
           faultKnowledgeBaseTypeService.deleteById(id);
       } catch (Exception e) {
