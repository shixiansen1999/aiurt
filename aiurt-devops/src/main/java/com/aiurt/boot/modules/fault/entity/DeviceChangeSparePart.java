...
@ApiModel(value="device_change_spare_part对象", description="故障更换备件表")
public class DeviceChangeSparePart {
	...
	/**类型:1-检修 2-故障*/
	@Excel(name = "类型:1-检修 2-故障", width = 15)
	@ApiModelProperty(value = "类型:1-检修 2-故障")
	...
	/**原备件所在班组*/
	@Excel(name = "原备件所在班组", width = 15)
	@ApiModelProperty(value = "新备件所在班组")
