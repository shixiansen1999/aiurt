...
import com.swsc.copsms.common.util.MD5Util;
...
import com.swsc.copsms.modules.system.model.SysPermissionTree;
...
import com.swsc.copsms.modules.system.util.PermissionDataUtil;
...
//	@RequiresRoles({ "admin" })
	...
	/**
	 * 判断是否外网URL 例如： http://localhost:8080/swsc/swagger-ui.html#/ 支持特殊格式： {{
