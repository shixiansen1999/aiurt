		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new SwscException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
