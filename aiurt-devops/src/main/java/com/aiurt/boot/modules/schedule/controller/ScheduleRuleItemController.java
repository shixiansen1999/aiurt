...
public class ScheduleRuleItemController {
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule_item-分页列表查询")
	@ApiOperation(value="schedule_rule_item-分页列表查询", notes="schedule_rule_item-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule_item-添加")
	@ApiOperation(value="schedule_rule_item-添加", notes="schedule_rule_item-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule_item-编辑")
	@ApiOperation(value="schedule_rule_item-编辑", notes="schedule_rule_item-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule_item-通过id删除")
	@ApiOperation(value="schedule_rule_item-通过id删除", notes="schedule_rule_item-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule_item-批量删除")
	@ApiOperation(value="schedule_rule_item-批量删除", notes="schedule_rule_item-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "schedule_rule_item-通过id查询")
	@ApiOperation(value="schedule_rule_item-通过id查询", notes="schedule_rule_item-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      //导出文件名称
      mv.addObject(NormalExcelConstants.FILE_NAME, "schedule_rule_item列表");
      mv.addObject(NormalExcelConstants.CLASS, ScheduleRuleItem.class);
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("schedule_rule_item列表数据", "导出人:Jeecg", "导出信息"));
