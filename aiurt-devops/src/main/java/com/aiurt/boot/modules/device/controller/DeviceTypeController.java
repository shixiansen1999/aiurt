...
public class DeviceTypeController {
	...
	public Result<IPage<DeviceType>> queryPageList(DeviceType deviceType,
		...
		Result<IPage<DeviceType>> result = new Result<IPage<DeviceType>>();
	...
	public Result<DeviceType> add(@RequestBody DeviceType deviceType) {
		Result<DeviceType> result = new Result<DeviceType>();
		try {
			deviceType.setCreateBy("admin");
			deviceType.setUpdateBy("admin");
	...
	public Result<DeviceType> edit(@RequestBody DeviceType deviceType) {
		Result<DeviceType> result = new Result<DeviceType>();
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("设备分类列表数据", "导出人:Jeecg", "导出信息"));
