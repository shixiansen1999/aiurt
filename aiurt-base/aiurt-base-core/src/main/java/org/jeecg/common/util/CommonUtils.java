...
public class CommonUtils {
    ...
    public static String uploadLocal(MultipartFile mf,String bizPath,String uploadpath){
        try {
            ...
            String dbpath = null;
            if(com.aiurt.common.util.oConvertUtils.isNotEmpty(bizPath)){
                dbpath = bizPath + File.separator + fileName;
            }else{
                dbpath = fileName;
            }
    ...
    public static String getDatabaseType() {
        if(com.aiurt.common.util.oConvertUtils.isNotEmpty(DB_TYPE)){
            return DB_TYPE;
        }
    ...
    public static DbType getDatabaseTypeEnum() {
        if (com.aiurt.common.util.oConvertUtils.isNotEmpty(dbTypeEnum)) {
            return dbTypeEnum;
        }
        try {
            DataSource dataSource = SpringContextUtils.getApplicationContext().getBean(DataSource.class);
    ...
    public static Connection getDataSourceConnect(String sourceKey) throws SQLException {
        if (com.aiurt.common.util.oConvertUtils.isEmpty(sourceKey)) {
            sourceKey = "master";
        }
        DynamicDataSourceProperties prop = SpringContextUtils.getApplicationContext().getBean(DynamicDataSourceProperties.class);
        Map<String, DataSourceProperty> map = prop.getDatasource();
    ...
    public static String getBaseUrl(HttpServletRequest request) {
        ...
        if(com.aiurt.common.util.oConvertUtils.isNotEmpty(xGatewayBasePath)){
