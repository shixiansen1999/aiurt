...
public enum DataScopeType {
     ...
     * 查看管理专业
     */
    TYPE_MANAGE_MAJOR_ONLY("TYPE_MANAGE_MAJOR_ONLY", " #{#majorName} IN ( #{@sdss.getMajorByUserIdStr( #sysUser.id )} ) ", ""),

    /**
     * 查看管理子系统
     */
    TYPE_MANAGE_SYSTEM_ONLY("TYPE_MANAGE_SYSTEM_ONLY", " #{#systemName} IN ( #{@sdss.getSubsystemByUserIdStr( #sysUser.id )} )", ""),

    /**
     * 查看管理部门
     */
    TYPE_MANAGE_DEPT("TYPE_MANAGE_DEPT", " #{#deptName} IN ( #{@sdss.getDepartByUserIdStr( #sysUser.id )})", ""),
