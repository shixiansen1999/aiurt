...
public class Device extends DictEntity {
	...
	/**所属专业*/
	@Excel(name = "所属专业", width = 15,needMerge = true)
	@ApiModelProperty(value = "所属专业")
	@Dict(dictTable ="cs_major",dicText = "major_name",dicCode = "major_code")
	@MajorFilterColumn
	private  String  majorCode;
	/**所属专业名称*/
	@Excel(name = "所属专业名称", width = 15,needMerge = true)
	...
	/**设备名称*/
	@Excel(name = "设备名称", width = 15,needMerge = true)
	@ApiModelProperty(value = "设备名称")
	private  String  name;

	/**设备编号*/
	@Excel(name = "设备编号", width = 15,needMerge = true)
	...
	/**资产编号*/
	@Excel(name = "资产编号", width = 15,needMerge = true)
	@ApiModelProperty(value = "资产编号")
	private  String  assetCode;

	/**设备管理员*/
	@Excel(name = "设备管理员", width = 15,needMerge = true)
	@ApiModelProperty(value = "设备管理员")
	@Dict(dictTable ="sys_user",dicText = "realname",dicCode = "username")
	private  String  manageUserName;
	/**设备管理员名称*/
	@Excel(name = "设备管理员名称", width = 15,needMerge = true)
	...
	/**负责班组名称*/
	@Excel(name = "负责班组名称", width = 15,needMerge = true)
	...
	/**临时设备(是/否（默认否）1是,0:否)*/
	@Excel(name = "是否临时设备", width = 15,needMerge = true)
	@ApiModelProperty(value = "临时设备(是/否（默认否）1是,0:否)")
	@TableField(exist = false)
...
//	@Excel(name = "设备复用类型(1:多线路复用/0:多站点复用)", width = 15)
	...
	@Excel(name = "设备复用类型", width = 15,needMerge = true)
	@ApiModelProperty(value = "设备复用类型(1:多线路复用/0:多站点复用)")
	@TableField(exist = false)
	private  String  reuseTypeName;

	/**出厂日期*/
	@Excel(name = "出厂日期", width = 15,needMerge = true)
	...
	/**设备等级(字典值)*/
	@Excel(name = "设备等级", width = 15,needMerge = true)
	@ApiModelProperty(value = "设备等级")
	@TableField(exist = false)
	private  String  deviceLevelName;

	/**品牌*/
	@Excel(name = "品牌", width = 15,needMerge = true)
	@ApiModelProperty(value = "品牌")
	private  String  brand;

	/**供应商(厂商信息表_编码)*/
	@Excel(name = "供应商(厂商信息表_编码)", width = 15,needMerge = true)
	@ApiModelProperty(value = "供应商(厂商信息表_编码)")
	@Dict(dictTable ="cs_manufactor",dicText = "name",dicCode = "id")
	private  String  manufactorCode;
	/**生产厂商手动翻译*/
	@Excel(name = "生产厂商手动翻译", width = 15,needMerge = true)
	@ApiModelProperty(value = "生产厂商手动翻译")
	@TableField(exist = false)
	private  String  manufactorCodeName;

	/**设备sn*/
	@Excel(name = "设备SN", width = 15,needMerge = true)
	@ApiModelProperty(value = "设备sn")
	@TableField(value = "device_sn")
	private  String  deviceSn;

	/**设备ip*/
	@Excel(name = "设备IP", width = 15,needMerge = true)
	@ApiModelProperty(value = "设备ip")
	private  String  deviceIp;

	/**出厂编号*/
	@Excel(name = "出厂编号", width = 15,needMerge = true)
	@ApiModelProperty(value = "出厂编号")
	private  String  factoryCode;

	/**生产日期*/
	@Excel(name = "生产日期", width = 15, format = "yyyy-MM-dd",needMerge = true)
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
	@DateTimeFormat(pattern="yyyy-MM-dd")
	...
	/**开始使用日期*/
	@Excel(name = "开始使用日期", width = 15, format = "yyyy-MM-dd",needMerge = true)
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
	@DateTimeFormat(pattern="yyyy-MM-dd")
	...
	/**使用年限*/
	@Excel(name = "使用年限", width = 15,needMerge = true)
	@ApiModelProperty(value = "使用年限")
	private  Integer  serviceLife;

	/**技术参数*/
	@Excel(name = "技术参数", width = 15,needMerge = true)
	...
	/**价格*/
	@Excel(name = "价格", width = 15,needMerge = true)
	...
	@Excel(name = "巡检标准Code",needMerge = true)
