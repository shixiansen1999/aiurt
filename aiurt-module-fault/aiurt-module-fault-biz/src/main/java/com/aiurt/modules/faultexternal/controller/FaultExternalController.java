...
public class FaultExternalController extends BaseController<FaultExternal, IFaultExternalService> {
	...
	public Result<String> add(@RequestBody FalutExternalReceiveDTO falutExternalReceiveDTO) {
	 ...
	 public Result<FaultExternal> appendFault(@RequestBody JSONObject formData) {
		 return  faultExternalService.appendFault(formData);
	 }
	 ...
	 * @return
	 */
	@AutoLog(value = "调度系统故障-通过id删除", operateType = 4, permissionUrl = "/fault/FaultExternalList")
	 ...
	 * @return
	 */
	@AutoLog(value = "调度系统故障-批量删除", operateType = 4, permissionUrl = "/fault/FaultExternalList")
