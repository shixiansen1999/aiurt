...
public class BdTrainStudentFeedbackRecordController extends BaseController<BdTrainStudentFeedbackRecord, IBdTrainStudentFeedbackRecordService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "学员反馈记录-通过id删除",operateType = 4,permissionUrl = "/trainAss/questionFeedback/QuestionFeedbackList")
	 ...
	 * @return
	 */
	@AutoLog(value = "学员反馈记录-批量删除",operateType = 4,permissionUrl = "/trainAss/questionFeedback/QuestionFeedbackList")
