...
public interface ScheduleRuleItemMapper extends BaseMapper<ScheduleRuleItem> {
    ...
    @Select("select a.*,b.name as itemName,b.start_time as startTime,b.end_time as endTime,b.time_id as timeId from schedule_rule_item a left join schedule_item b on a.item_id=b.id where b.del_flag= 0 and a.rule_id=#{ruleId} ")
