package com.aiurt.modules.train.traindegreerecord.entity;
 ...
 */
@Data
@TableName("train_degree_record")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="train_degree_record对象", description="train_degree_record")
public class TrainDegreeRecord extends DictEntity implements Serializable {
