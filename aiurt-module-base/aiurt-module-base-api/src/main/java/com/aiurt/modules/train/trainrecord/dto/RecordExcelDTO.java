package com.aiurt.modules.train.trainrecord.dto;
...
public class RecordExcelDTO extends DictEntity implements Serializable {
    ...
    @ApiModelProperty(value = "培训时间")
    @TableField(exist = false)
    private String excelTrainTime;
    @TableField(exist = false)
    private String excelHour;
    @TableField(exist = false)
