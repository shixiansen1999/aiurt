package com.aiurt.modules.train.trainjobchangerecord.dto;
...
public class JobChangeRecordExcelDTO extends DictEntity implements Serializable {
    ...
    @Excel(name = "上岗时间", width = 15)
    @ApiModelProperty(value = "上岗时间")
    @TableField(exist = false)
    private String excelJobTime;
	/**创建时间*/
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
