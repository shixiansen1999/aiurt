...
public class ArchiveExcelDTO extends DictEntity implements Serializable {
    ...
    private DegreeRecordExcelDTO firstDegree;
    @ApiModelProperty(value = "最高学历")
    private  DegreeRecordExcelDTO highestDegree;
    /**岗位变动记录*/
    @ApiModelProperty(value = "岗位变动记录")
    @TableField(exist = false)
    private List<JobChangeRecordExcelDTO> changeRecordList;
    /**培训记录*/
    @ApiModelProperty(value = "培训记录")
    @TableField(exist = false)
    private List<RecordExcelDTO> trainRecordList;
    /**培训记录*/
    @ApiModelProperty(value = "部门集合")
    @TableField(exist = false)
    private List<String> orgCodeList;
    @ApiModelProperty(value = "学历导入")
    private  String teDegreeName;
    @ApiModelProperty(value = "个人信息错误原因")
    private  String archiveMistake;
    @ApiModelProperty(value = "第一学历错误原因")
    private  String firstMistake ;
    @ApiModelProperty(value = "最高学历错误原因")
    private  String highestMistake;
    @ApiModelProperty(value = "岗位变动错误原因")
    private  String changeMistake;
    @ApiModelProperty(value = "培训记录错误原因")
    private  String recordMistake;
