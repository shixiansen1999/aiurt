...
import com.aiurt.boot.rehearsal.entity.EmergencyPlanRecordProblemMeasures;
import com.aiurt.boot.rehearsal.service.IEmergencyPlanRecordProblemMeasuresService;
...
public class EmergencyPlanRecordProblemMeasuresController extends BaseController<EmergencyPlanRecordProblemMeasures, IEmergencyPlanRecordProblemMeasuresService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_record_problem_measures-分页列表查询")
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_record_problem_measures-通过id查询")
