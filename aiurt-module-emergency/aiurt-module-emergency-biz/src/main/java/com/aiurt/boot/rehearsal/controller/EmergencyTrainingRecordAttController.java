...
import com.aiurt.boot.rehearsal.entity.EmergencyTrainingRecordAtt;
import com.aiurt.boot.rehearsal.service.IEmergencyTrainingRecordAttService;
...
public class EmergencyTrainingRecordAttController extends BaseController<EmergencyTrainingRecordAtt, IEmergencyTrainingRecordAttService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_training_record_att-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_training_record_att-批量删除")
