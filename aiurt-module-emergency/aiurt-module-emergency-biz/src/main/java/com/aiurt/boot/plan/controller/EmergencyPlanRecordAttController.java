...
public class EmergencyPlanRecordAttController extends BaseController<EmergencyPlanRecordAtt, IEmergencyPlanRecordAttService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_record_att-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_record_att-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
