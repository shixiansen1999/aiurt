...
public class EmergencyPlanRecordDisposalProcedureController extends BaseController<EmergencyPlanRecordDisposalProcedure, IEmergencyPlanRecordDisposalProcedureService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_record_disposal_procedure-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_record_disposal_procedure-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
