...
import com.aiurt.boot.rehearsal.entity.EmergencyPlanRecordMaterials;
import com.aiurt.boot.rehearsal.service.IEmergencyPlanRecordMaterialsService;
 ...
 * @Version: V1.0
 */
@Api(tags="emergency_plan_record_materials")
@RestController
...
public class EmergencyPlanRecordMaterialsController extends BaseController<EmergencyPlanRecordMaterials, IEmergencyPlanRecordMaterialsService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_record_materials-分页列表查询")
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_record_materials-通过id查询")
