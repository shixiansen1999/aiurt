 ...
 * @Version: V1.0
 */
@Api(tags="emergency_rehearsal_month")
@RestController
...
public class EmergencyRehearsalMonthController extends BaseController<EmergencyRehearsalMonth, IEmergencyRehearsalMonthService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_rehearsal_month-分页列表查询")
	@ApiOperation(value="emergency_rehearsal_month-分页列表查询", notes="emergency_rehearsal_month-分页列表查询")
