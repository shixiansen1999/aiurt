...
import com.aiurt.boot.rehearsal.entity.EmergencyPlanRecordDepart;
import com.aiurt.boot.rehearsal.service.IEmergencyPlanRecordDepartService;
...
public class EmergencyPlanRecordDepartController extends BaseController<EmergencyPlanRecordDepart, IEmergencyPlanRecordDepartService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_record_depart-分页列表查询")
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_record_depart-通过id查询")
