...
public class EmergencyPlanMaterialsController extends BaseController<EmergencyPlanMaterials, IEmergencyPlanMaterialsService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_materials-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "/emergency/emergencyMaterials/AccountList")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_materials-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "/emergency/emergencyMaterials/AccountList")
