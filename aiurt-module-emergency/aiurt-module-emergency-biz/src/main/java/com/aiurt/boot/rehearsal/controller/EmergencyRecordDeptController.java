...
public class EmergencyRecordDeptController extends BaseController<EmergencyRecordDept, IEmergencyRecordDeptService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_record_dept-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_record_dept-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
