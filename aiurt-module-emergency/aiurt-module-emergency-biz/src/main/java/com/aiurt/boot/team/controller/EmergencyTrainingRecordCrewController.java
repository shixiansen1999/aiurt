...
public class EmergencyTrainingRecordCrewController extends BaseController<EmergencyTrainingRecordCrew, IEmergencyTrainingRecordCrewService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_training_record_crew-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_training_record_crew-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
