...
import com.aiurt.boot.rehearsal.entity.EmergencyPlanTeam;
import com.aiurt.boot.rehearsal.service.IEmergencyPlanTeamService;
...
public class EmergencyPlanTeamController extends BaseController<EmergencyPlanTeam, IEmergencyPlanTeamService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_team-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_team-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_team-批量删除")
	 ...
	 * @return
	 */
	//@AutoLog(value = "emergency_plan_team-通过id查询")
