...
public class EmergencyRecordStepController extends BaseController<EmergencyRecordStep, IEmergencyRecordStepService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_record_step-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_record_step-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
