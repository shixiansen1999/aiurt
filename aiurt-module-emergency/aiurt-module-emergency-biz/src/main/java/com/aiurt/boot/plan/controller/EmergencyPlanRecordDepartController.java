...
public class EmergencyPlanRecordDepartController extends BaseController<EmergencyPlanRecordDepart, IEmergencyPlanRecordDepartService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_record_depart-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_plan_record_depart-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
