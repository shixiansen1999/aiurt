...
public class EmergencyRecordQuestionController extends BaseController<EmergencyRecordQuestion, IEmergencyRecordQuestionService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_record_question-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
	 ...
	 * @return
	 */
	@AutoLog(value = "emergency_record_question-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "")
