...
public class EmergencyTeamController extends BaseController<EmergencyTeam, IEmergencyTeamService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "应急队伍台账-通过id删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "/emergency/emergencyTeam/EmergencyTeamList")
	 ...
	 * @return
	 */
	@AutoLog(value = "应急队伍台账-批量删除", operateType = 4, operateTypeAlias = "删除", permissionUrl = "/emergency/emergencyTeam/EmergencyTeamList")
