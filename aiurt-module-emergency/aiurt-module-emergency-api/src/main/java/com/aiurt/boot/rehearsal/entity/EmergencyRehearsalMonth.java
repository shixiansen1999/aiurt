...
public class EmergencyRehearsalMonth extends DictEntity implements Serializable {
	...
	/**演练科目*/
    @Excel(name = "演练科目", orderNum = "0", width = 15)
	...
	/**演练形式(1实战演练、2桌面推演)*/
    @Excel(name = "演练形式", dicCode = EmergencyDictConstant.MODALITY, orderNum = "3", width = 15)
	...
	/**组织部门编码*/
    @Excel(name = "组织部门", dictTable = "sys_depart", dicCode = "org_code", dicText = "depart_name", orderNum = "5", width = 15)
