...
public class DySmsHelper {
    ...
    static String accessKeyId = "LTAIwilHY2pQfbfJ";
    static String accessKeySecret = "EuBrbb8mrJoufONlVnsGYn3vzyZxRD";
    ...
    public static boolean sendSms(String phone,JSONObject templateParamJson,DySmsEnum dySmsEnum) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIwilHY2pQfbfJ", "EuBrbb8mrJoufONlVnsGYn3vzyZxRD");
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
    	...
    	obj.put("code", "524178");
    	sendSms("18829211442", obj, DySmsEnum.LOGIN_TEMPLATE_CODE);
