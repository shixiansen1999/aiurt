 ...
 * @Version: V1.0
 */
@Api(tags="fixed_assets_category")
@RestController
...
public class FixedAssetsCategoryController extends BaseController<FixedAssetsCategory, IFixedAssetsCategoryService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "fixed_assets_category-分页列表查询")
	@ApiOperation(value="fixed_assets_category-分页列表查询", notes="fixed_assets_category-分页列表查询")
	@GetMapping(value = "/list")
	public Result<IPage<FixedAssetsCategory>> queryPageList(FixedAssetsCategory fixedAssetsCategory,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<FixedAssetsCategory> queryWrapper = QueryGenerator.initQueryWrapper(fixedAssetsCategory, req.getParameterMap());
		Page<FixedAssetsCategory> page = new Page<FixedAssetsCategory>(pageNo, pageSize);
		IPage<FixedAssetsCategory> pageList = fixedAssetsCategoryService.page(page, queryWrapper);
	 ...
	 * @return
	 */
	@AutoLog(value = "fixed_assets_category-添加")
	@ApiOperation(value="fixed_assets_category-添加", notes="fixed_assets_category-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "fixed_assets_category-编辑")
	@ApiOperation(value="fixed_assets_category-编辑", notes="fixed_assets_category-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "fixed_assets_category-通过id删除")
	@ApiOperation(value="fixed_assets_category-通过id删除", notes="fixed_assets_category-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "fixed_assets_category-批量删除")
	@ApiOperation(value="fixed_assets_category-批量删除", notes="fixed_assets_category-批量删除")
