 ...
 */
@Data
@TableName("work_area_org")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="work_area_org对象", description="work_area_org")
public class WorkAreaOrg implements Serializable {
    private static final long serialVersionUID = 1L;

	/**工区组织机构关联表主键*/
	@TableId(type = IdType.ASSIGN_ID)
    @ApiModelProperty(value = "工区组织机构关联表主键")
