 ...
 */
@Data
@TableName("work_area_station")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="work_area_station对象", description="work_area_station")
public class WorkAreaStation implements Serializable {
    private static final long serialVersionUID = 1L;

	/**工区站所关联表主键*/
	@TableId(type = IdType.ASSIGN_ID)
    @ApiModelProperty(value = "工区站所关联表主键")
