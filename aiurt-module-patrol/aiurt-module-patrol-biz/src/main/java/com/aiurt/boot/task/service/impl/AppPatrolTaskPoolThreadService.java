 ...
 */
public class AppPatrolTaskPoolThreadService implements Callable<PatrolTaskDTO> {
    ...
    public AppPatrolTaskPoolThreadService(PatrolTaskDTO patrolTaskDTO, PatrolTaskMapper patrolTaskMapper, PatrolTaskStandardMapper patrolTaskStandardMapper, PatrolManager manager, ISysBaseAPI sysBaseApi) {
