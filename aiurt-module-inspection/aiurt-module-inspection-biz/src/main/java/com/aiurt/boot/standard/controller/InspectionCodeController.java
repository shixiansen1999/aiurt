...
public class InspectionCodeController extends BaseController<InspectionCode, IInspectionCodeService> {
     ...
     * @return
     */
    @AutoLog(value = "检修标准表-通过id删除", operateType =  4, operateTypeAlias = "通过id删除", module = ModuleType.INSPECTION,permissionUrl="/overhaul/standardManage")
     ...
     * @return
     */
    @AutoLog(value = "检修标准表-批量删除", operateType =  4, operateTypeAlias = "批量删除", module = ModuleType.INSPECTION,permissionUrl="/overhaul/standardManage")
