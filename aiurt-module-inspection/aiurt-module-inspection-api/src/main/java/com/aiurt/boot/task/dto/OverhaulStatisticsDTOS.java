 ...
 */
@Data
public class OverhaulStatisticsDTOS {
    ...
    public boolean equals(Object o){
        if (o instanceof OverhaulStatisticsDTOS){
            OverhaulStatisticsDTOS overhaulStatisticsDTO = (OverhaulStatisticsDTOS) o ;
            return this.getOrgCode().equals(overhaulStatisticsDTO.getOrgCode());
        }
        return false;
    }
