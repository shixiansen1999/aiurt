...
public class InspectionStrategyExcelDTO {
    ...
    /**检修周期类型*/
    @Excel(name = "检修周期类型", width = 15,needMerge = true,replace = {"周期_0","月检_1","双月检_2","季检_3","半年检_4","年检_5","无_null"})
    ...
    /**是否需要确认：0否 1是*/
    @Excel(name = "是否需要确认", width = 15,needMerge = true,replace = {"否_0","是_1","无_null"})
